...
public class AdministradorJpaController implements Serializable {
    ...
    public void create(Administrador administrador) {
        ...
        try {
            ...
            UsrComunidad usuario = administrador.getUsuario();
            if (usuario != null) {
            ...
            if (usuario != null) {
                usuario.getAdministradorCollection().add(administrador);
    ...
    public void edit(Administrador administrador) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            UsrComunidad usuarioOld = persistentAdministrador.getUsuario();
            UsrComunidad usuarioNew = administrador.getUsuario();
            if (usuarioNew != null) {
            ...
            if (usuarioOld != null && !usuarioOld.equals(usuarioNew)) {
                usuarioOld.getAdministradorCollection().remove(administrador);
                usuarioOld = em.merge(usuarioOld);
            }
            if (usuarioNew != null && !usuarioNew.equals(usuarioOld)) {
                usuarioNew.getAdministradorCollection().add(administrador);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            UsrComunidad usuario = administrador.getUsuario();
            if (usuario != null) {
                usuario.getAdministradorCollection().remove(administrador);
                usuario = em.merge(usuario);
            }
